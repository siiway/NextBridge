...
features:
  - title: 多平台支持
    details: 开箱即用地支持 QQ（通过 NapCat）、Discord、Telegram、飞书/Lark、钉钉、云湖、KOOK、Matrix、Signal、Slack、Google Chat、Mattermost、VoceChat 和 Rocket.Chat。[查看支持状态](/zh/platform-support)。
  - title: 配置驱动的消息路由
